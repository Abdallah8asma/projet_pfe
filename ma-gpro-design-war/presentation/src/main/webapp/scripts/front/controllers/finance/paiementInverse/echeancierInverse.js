...
angular
    .module('gpro.echeancierInverse', [])
    .controller(
        'EcheancierInverseController', [
            '$scope',
            '$http',
            '$log',
            '$filter',
...
//					                		  "dateReglementAu":""};
                    ...
                    $http
                        .post(
                            UrlAtelier +
                            "/echeancierInverseClient/rechercheMulticritere",
                            echeancierCourant)
		...
		var conf = confirm("Veuillez confirmer la modification !")
		      ...
		      if(conf){
			     ...
			     $http
                      .get(
                        UrlAtelier
                          + "/detailsReglementInverse/updateReglee?detailReglementId="+idDetailReglement+"&reglee="+isReglee)
                      .success(
                        function(data) {
