...
angular
    .module('gpro.elementReglementAchat', [])
    .controller(
        'ElementReglementAchatController', [
        '$scope',
        '$http',
        '$log',
        '$filter',
        ...
        function ($scope, $http, $log, $filter,
             ...
             * par detail reglement au niveau de la partie back-end "/elementReglementAchat/rechercheMulticritere"**/
            ...
            $scope.rechercheReglement = function (reglementCourante) {
                ...
                $http
                    .post(
                        UrlAtelier +
                        "/elementReglementAchat/rechercheMulticritere",
                        reglementCourante)
			...
			$scope.downloadAllReglements = function (
				...
				$http({
					url: UrlAtelier + "/fichesAchat/listElementReglement",
					method: "POST",
					...
					var fileName = 'detail_reglement_achat' + formattedDate(new Date());
...
/*            //generer rapport de tous les Reglement : List
            $scope.downloadAllReglementss = function (reglementCourante) {
                ...
                url = UrlAtelier + "/reportgc/elementReglementAchatList?partieIntId=" + reglementCourante.partieIntId
...
/*
            ...
            $scope.downloadReglement = function (reglementCourante) {
                ...
                url = UrlAtelier + "/reportgc/elementReglementAchat?id=" + reglementCourante.id + "&type=pdf";
