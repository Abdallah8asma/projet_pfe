'use strict';
angular
  .module('gpro.partieInteresseeFournisseur', ['ngResource'])
  .controller('PartieInteresseeFournisseurController', [
    '$scope',
    '$filter',
    '$http',
    '$log',
    ...
    'UrlCommun',
    '$window',
    function ($scope, $filter, $http, $log, downloadService, UrlCommun,$window) {
      ...
      $log.info('***Sous Menu fournisseur ***');
      ...
      $scope.downloadAllExcel = function (partieInteresseeCourante) {
        ...
        downloadService.download(url).then(function (result) {
          ...
          fileName[0] =  'Liste_Fournisseur_' + formattedDate(new Date());
   ...
   // Liste des TypeDocs
       ...
       $http
         ...
         .success(
           function(dataTypeDocCache) {
            ...
            $scope.listeTypeDocumentCache = dataTypeDocCache.filter(e => e.module === 'PI_FOURNISSEUR'); 
      ...
      $scope.listePartieInteressee = function () {
        $http.get(UrlCommun + '/partieInteressee/all').success(function (data) {
      ...
      $scope.rechercherPartieInteressee = function (partieInteresseeCourante) {
        ...
        /** permet de récuperer seulement les PI de famille fournisseur */
        partieInteresseeCourante.vFamillePartieInteressee = 2;
        $http
          .post(
      ...
      $scope.modifierOuCreerPartieInteressee = function () {
        ...
        // getArticle
        $http
          .get(UrlCommun + '/partieInteressee/getId:' + $scope.myData[index].id)
          .success(function (datagetPI) {
      ...
      $scope.creerPartieInteressee = function (partieInteressee) {
        ...
        /** permet de client un PI de famille Fournisseur **/
        partieInteressee.famillePartieInteressee = 2;
        $http
          .post(
			...
			
          {
            ...
            `<div class="ms-CommandButton float-right">
             <button class="ms-CommandButton-button ms-CommandButton-Gpro " ng-click="modifierOuCreerPartieInteressee()">
              ...
              <button class="ms-CommandButton-button"  ng-click="showPopupDelete(1)" permission="['Fournisseur_Delete']">
      ...
      $scope.showStatus = function (id) {
        ...
        for (var i = 0; i < $scope.listeTypeDocumentCache.length; i++) {
          ...
          if (
            ...
            $scope.listeTypeDocumentCache[i].module == 'PI_FOURNISSEUR'
          ) {
