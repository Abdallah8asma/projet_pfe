...
angular
    .module('gpro.soldeClient', [])
    .controller(
        'soldeClientController', [
        '$scope',
        '$http',
        '$log',
        '$filter',
        ...
        function ($scope, $http, $log, $filter,
            ...
            $scope.recherchesoldeCl = function (soldeClCourante) {
                ...
                $http
                    .post(
                        UrlAtelier +
                        "/soldeClient/rechercheMulticritere",
                        soldeClCourante)
            ...
            $scope.modifierOuCreersoldeCl = function () {
                ...
                $http
                    ...
                    .success(
                        function (datagetsoldeCl) {

                        });

                $scope.soldeClCourante = $scope.myData[index] ? angular
                    ...
                    function () {
                        $scope.colDefs = [
                            ...
                            },
                            {
                                ...
                                field: 'bloque',
                                displayName: 'Bloquée',
                                cellTemplate: '<input type="checkbox" ng-model="row.entity.bloque" ng-change="ffff" style="margin: 8px;" ng-disabled="true"/>',
                               width: '5%'
                            }, {
                                field: 'seuil',
                                displayName: 'Seuil',
            ...
            $scope.downloadAll = function (soldeClCourante) {
                ...
                console.log("------- soldeClCourante " + JSON.stringify(soldeClCourante, null, "  "));
                var url = UrlAtelier + "/reportgc/soldeClient?clientId=" + soldeClCourante.partieIntId
                    + "&bloque=" + soldeClCourante.bloque
                    + "&type=pdf";
            ...
            $scope.Valider = function (clientID) {
                ...
                $http
                    .get(UrlAtelier
                        + "/reglement/validateByClientId:" + clientID)
                    .success(
                        function (soldeCl) {
