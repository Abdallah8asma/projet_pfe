...
angular
		.module('atelier.logistique', [ "ngResource", "ngCsvImport" ])
		.controller(
				...
				[
						...
						function($scope, $filter, $http, $log, $parse,
							...
							$scope.selectedReferenceProduit ='';
							...
							$scope.changeProduits = function(id){
								...
								$scope.selectedReferenceProduit =element[0].reference;
								
								var elementRech = {produitId : id , statut : 'En cours'};
								...
								.success(
										function(resultat) {
											$scope.listMiseEncours = resultat.listeElementRechecheMiseValeur;
