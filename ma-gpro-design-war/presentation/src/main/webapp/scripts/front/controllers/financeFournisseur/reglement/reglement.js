        	...
        	angular
        	    .module('gpro.reglementfournisseur', [])
        	    .controller(
        	        'ReglementFournisseurController', [
        	            ...
        	            function($scope, $http,$log, $filter,
        	                ...
        	                $rootScope,$route, initCommercialService,$window) {
        	               $log.info("=========Reglement========");
            ...
            $scope.getListeBanquePI();
        	                ...
        	                $scope.rechercheReglement = function(reglementCourante) {
        	                    ...
        	                    $http
        	                        .post(
        	                            UrlAtelier +
        	                            "/reglementAchat/rechercheMulticritere",
        	                            reglementCourante)
...
//        	                                  $scope.deleteValue);
        	                             ...
        	                             // $scope.Valider(datagetReglement.partieIntId);
        	                              ...
        	                              $scope.reglementCourante.idDepot=datagetReglement.idDepot;
        	                               $scope.finalOperationsList=datagetReglement.listDetailsReglement;
																				 ...
																				 $scope.listDocReglement = datagetReglement.listDocReglement;
        	      ...
        	      /******************************************************************************/
        	        ...
        	        $scope.updateReglement= function(reglement) {
										reglement.listDocReglement = $scope.listDocReglement;
...
//        	                   }
        	                ...
        	                $scope.downloadAllReglements = function(reglementCourante) {
        	                  ...
        	                  url = UrlAtelier + "/reportAchat/reglementList?partieIntId=" + reglementCourante.partieIntId
        	                 ...
        	                 $scope.downloadReglement = function(reglementCourante) {
        	                   ...
        	                   url = UrlAtelier + "/reportAchat/reglement?id=" + reglementCourante.id + "&type=pdf";
        	              	...
        	              	/***************************************************
								 ...
								 **************************************************/
								$scope.name = "FINANCE_FOURNISSEUR_REGLEMENT";

								$scope.listeTypeDocumentsCache = $scope.listeTypeDocumentsCacheALL.filter(e => e.module === 'FINANCE_FOURNISSEUR_REGLEMENT');
							 ...
							 $scope.ajoutDocumentReceptionAchat = function() {
								 ...
								 $scope.documentReglementAchatInserree = {
								 ...
								 $scope.listDocReglement
										 .push($scope.documentReglementAchatInserree);
        	                                  ...
        	                                  
        	                                 {
        	                                  ...
        	                                  { 
        	                                      ...
        	                                      width:'10%',
																							...
																							<button class="ms-CommandButton-button" ng-click="showPopupDelete(10)" permission="['Finance_Fournisseur_Delete']">
        	                                      ...
        	                                      //     '<button data-nodrag class="btn btn-default btn-xs" ng-click="showPopupDelete(10)"> <i class="fa fa-fw fa-trash-o"></i></button></div>'
        	                                  }
        	                              ];
        	                          });
        	        ...
        	        //boutton valider les reglements
        	         $scope.Valider = function(clientID) {
        	                    ...
        	                    $http
        	                           .get(UrlAtelier
        	                                   + "/reglementAchat/validateByFournisseurId:" +clientID)
        	                           .success(
        	                                   function(reglement) {
        	         ...
        	         $scope.ValiderGroupeClient = function(groupeClientId) {
        	                    ...
        	                    $http
        	                           .get(UrlAtelier
        	                                   + "/reglementAchat/validateByGroupeFournisseurId:" +groupeClientId)
        	                           .success(
        	                                   function(reglement) {
        	                                          $scope.finalBLList = reglement.listLivraisonNonRegle;
        	                                          $scope.finalFacturesList = reglement.listFactureNonRegle;
