 ...
 * @since 01/07/2016
 */
public class ResultatRechecheElementReglementElementValue
		implements Comparable<ResultatRechecheElementReglementElementValue> {
	...
	public int compareTo(ResultatRechecheElementReglementElementValue element) {
