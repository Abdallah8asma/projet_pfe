...
public class CommandeVenteValue implements Comparable<CommandeVenteValue> {
	...
	private List<ProduitCommandeValue> listProduitCommandes;

	/** The list produit taxes. */
	private List<TaxeCommandeValue> listProduitTaxes;
	 ...
	 */
	public List<ProduitCommandeValue> getListProduitCommandes() {
	 ...
	 */
	public void setListProduitCommandes(List<ProduitCommandeValue> listProduitCommandes) {
	 ...
	 */
	public List<TaxeCommandeValue> getListProduitTaxes() {
	 ...
	 */
	public void setListProduitTaxes(List<TaxeCommandeValue> listProduitTaxes) {
	...
	public String toString() {
		return "CommandeVenteValue [id=" + id + ", siteId=" + siteId + ", reference=" + reference + ", prixTotal="
	...
	public int compareTo(CommandeVenteValue o) {
		CommandeVenteValue commandeVenteValue = (CommandeVenteValue) o;
