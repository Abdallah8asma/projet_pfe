...
@Component
public class ReglementAchatDomaineImpl implements IReglementAchatDomaine{

	private static final Logger logger = LoggerFactory.getLogger(ReglementAchatDomaineImpl.class);
