...
deploy adapters: [tomcat9(credentialsId: 'Tomcat', path: '', url: 'http://18.215.247.91:8080/')], contextPath: '/ma-atelier-3.5.0.0-SNAPSHOT', war: 'ma-gpro-atelier-war/presentation/target/ma-atelier-3.5.0.0-SNAPSHOT.war'

                    // Déploiement de ma-gpro-design
                    deploy adapters: [tomcat9(credentialsId: 'Tomcat', path: '', url: 'http://18.215.247.91:8080/')], 
