...
WORKDIR /app/
COPY --from=BUILDER ./mt-gpro-commun/mt-gpro-commun-rest/target/mt-gpro-commun-3.5.0.0-SNAPSHOT.war /app/mt-gpro-commun.war
COPY --from=BUILDER ./ma-gpro-logistique/ma-gpro-logistique-rest/target/ma-gpro-logistique-rest-3.5.0.0-SNAPSHOT.war /app/ma-gpro-logistique.war
CMD java -jar /app/mt-gpro-commun.war && java -jar /app/ma-gpro-logistique.war