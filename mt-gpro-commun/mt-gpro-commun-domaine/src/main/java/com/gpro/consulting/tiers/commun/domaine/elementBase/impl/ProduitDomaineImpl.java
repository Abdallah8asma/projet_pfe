...
public class ProduitDomaineImpl implements IProduitDomaine {
	...
	public ResultatRechecheProduitValue rechercherProduitMultiCritereClient(
		...
		PartieInteresseValue pi = 	partieInteresseePersistance.getPartieInteresseById(piId);
			...
			//System.out.println("###########   pRechercheProduitMulitCritere.getPartieInteressee())  :  "+pRechercheProduitMulitCritere.getPartieInteressee());
			...
			for (ProduitValue prod :result.getProduitValues()){
				...
				if(pi.getGroupeClientId() != null &&  pRechercheProduitMulitCritere.getGroupeClientId() != null && pi.getGroupeClientId().equals(pRechercheProduitMulitCritere.getGroupeClientId()))
				{
				...
				PrixClientValue vPrixClient=prixClientPersistance.rechcherchePrixClientMC(vRecherchePrixClientMulitCritere);
	...
	public ProduitValue rechercheProduitParReference(String reference) {
		return produitPersistance.rechercheProduitParReference(reference);
	}
