 ...
 */
@Entity
@Table(name=IConstante.TABLE_OPTION_PRODUIT)
public class OptionProduitEntity implements Serializable{
	...
	/** The id. */
	@Id
	@SequenceGenerator(name="OPTION_PRODUIT_ID_GENERATOR", sequenceName = IConstante.SEQUENCE_OPTION_PRODUIT,allocationSize=1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator ="OPTION_PRODUIT_ID_GENERATOR")
	private Long id;
